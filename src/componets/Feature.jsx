...
const Feature = () => {
    return (
        <div className="ralative mt-20 border-b border-neutral-800 min-h-[800px]">
            {/* feature heading */}
            <div className="text-center">
                <span className='bg-neutral-800 text-orange-500 rounded-full
                 ...
                 <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-12 tracking-wide">
                    ...
                    <span className='bg-gradient-to-r from-orange-500 to-orange-800
                     text-transparent bg-clip-text'>{" "} your code</span>
                 </h2>
            </div>
